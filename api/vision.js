...
function buildPrompt(lang) {
  return (
    ...
    "5) 1-2 specific generic/active-ingredient chemical or biopesticide names commonly used in India for this exact problem (e.g. a named fungicide or insecticide active ingredient, not a brand), with a typical dose range per liter of water or per acre, plus a clear safety line: follow the product label exactly, wear gloves and a mask while spraying, respect the pre-harvest interval, keep it away from children and water sources, and confirm exact dosage with the local Krishi Vigyan Kendra (KVK) or agriculture officer since it can vary by formulation, crop variety, and region, " +
    "6) one prevention tip for next season. " +
    "Format as short lines starting with '- ', use **bold** only for the disease/pest name, no markdown headers, under 300 words total."
  );
}
